...
export const SPGNFTContractAddress: Address =
  (process.env.NEXT_PUBLIC_SPG_NFT_CONTRACT_ADDRESS as Address) ||
...
export const PILTemplateAddress: Address =
  "0x2E896b0b2Fdb7457499B56AAaA4AE55BCB4Cd316"; // Correct PIL Template address
...
export function getLicenseTermsByType(
  type: LicenseType
