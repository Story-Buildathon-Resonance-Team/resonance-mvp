...
export function DraftsList() {
  ...
  const handleDeleteDraft = (draftId: string, type: 'publish-form' | 'remix-form') => {
  ...
  const getAllDrafts = (): CombinedDraft[] => {
    ...
    if (publishFormData && (publishFormData.title || publishFormData.content) && publishFormData.lastSaved) {
      allDrafts.push({
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground mb-6">
          Start writing your first story or remix. Your work will be automatically saved as you write.
        </p>
      </div>
    );
  }
            ...
            <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
              <Link href={getEditLink(draft)}>
                ...
                >
                  ...
                  {draft.type === 'remix-form' ? 'Continue Remix' : 'Continue Story'}
                </Button>
              </Link>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>Delete {getDraftTypeLabel(draft.type)}</AlertDialogTitle>
                    <AlertDialogDescription>
